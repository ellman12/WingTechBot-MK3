...
export const validateCreateGuildMemberData = (data: unknown): CreateGuildMemberData =>
  CreateGuildMemberDataSchema.parse(data);
export const validateUpdateGuildMemberData = (data: unknown): UpdateGuildMemberData =>
  UpdateGuildMemberDataSchema.parse(data);
