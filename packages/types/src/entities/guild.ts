...
export const GuildSchema = z.object({
    ...
    prefix: z.string().max(5, "Guild prefix cannot be longer than 5 characters").regex(/^\S+$/, "Guild prefix cannot contain spaces"),
    isActive: z.boolean(),
...
export const CreateGuildDataSchema = z.object({
    ...
    prefix: z.string().max(5, "Guild prefix cannot be longer than 5 characters").regex(/^\S+$/, "Guild prefix cannot contain spaces").default("!"),
...
export const UpdateGuildDataSchema = z.object({
    ...
    prefix: z.string().max(5, "Guild prefix cannot be longer than 5 characters").regex(/^\S+$/, "Guild prefix cannot contain spaces").optional(),
...
export const validateCreateGuildData = (data: unknown): CreateGuildData => CreateGuildDataSchema.parse(data);
export const validateUpdateGuildData = (data: unknown): UpdateGuildData => UpdateGuildDataSchema.parse(data);
