...
export class FormatDetectionError extends AudioError {
    constructor(message: string, context?: { filePath?: string; url?: string }, options?: ErrorOptions) {
...
export class AudioFetchTimeoutError extends AudioError {
    constructor(message: string, context?: { url?: string; timeoutMs?: number }, options?: ErrorOptions) {
        super(message, context, options);
    }
}
...
export class AudioProcessingError extends AudioError {
    constructor(message: string, context?: { inputFormat?: string; outputFormat?: string; ffmpegError?: string }, options?: ErrorOptions) {
        super(message, context, options);
    }
}
...
export class AudioSizeLimitError extends AudioError {
    constructor(message: string, context?: { sizeBytes?: number; limitBytes?: number }, options?: ErrorOptions) {
        super(message, context, options);
    }
}
...
export class UnsupportedFormatError extends AudioError {
    constructor(message: string, context?: { format?: string; codec?: string }, options?: ErrorOptions) {
        super(message, context, options);
    }
}
