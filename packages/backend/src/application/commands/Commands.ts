...
import { createAutoSoundsCommands } from "@application/commands/AutoSoundsCommands.js";
...
export const createCommands = (
    ...
    const commandRecords = [
        createAutoSoundsCommands({ autoSoundsRepository, soundRepository, commandChoicesService }),
...
export const deployCommands = async (
    ...
    try {
        ...
        const commandMap = createCommands(autoSoundsRepository, soundRepository, soundService, soundTagService, voiceService, reactionRepository, emoteRepository, discordChatService, commandChoicesService);
...
export const registerCommands = (
    ...
    const commands = createCommands(autoSoundsRepository, soundRepository, soundService, soundTagService, voiceService, reactionRepository, emoteRepository, discordChatService, commandChoicesService);
