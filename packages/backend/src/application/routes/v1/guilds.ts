import { ApiMessageResponseSchema, ApiSuccessResponseSchema } from "@wingtechbot-mk3/types/api/v1/common";
import { ApiGuildSchema, CreateGuildRequestSchema, GuildParamsSchema, UpdateGuildRequestSchema } from "@wingtechbot-mk3/types/api/v1/guilds";
import type { Kysely } from "kysely";
import { z } from "zod/v4";

import { createGuildV1Handler, deleteGuildV1Handler, getGuildByIdV1Handler, getGuildsV1Handler, updateGuildV1Handler } from "../../../adapters/http/v1/controllers/GuildController.js";
...
export const createGuildRoutes = (db: Kysely<DB>): RouteGroup => ({
    ...
    tags: ["Guilds"],
    routes: [
        { method: "get", path: "", summary: "Get all guilds", description: "Retrieve a list of all Discord guilds", tags: ["Guilds"], handler: getGuildsV1Handler(db), responseSchema: GetGuildsV1ResponseSchema },
        {
            method: "get",
            path: "/{id}",
        ...
        { method: "delete", path: "/{id}", summary: "Delete a guild", description: "Remove a Discord guild entry", tags: ["Guilds"], handler: deleteGuildV1Handler(db), paramsSchema: GuildParamsSchema, responseSchema: DeleteGuildV1ResponseSchema },
    ],
});
