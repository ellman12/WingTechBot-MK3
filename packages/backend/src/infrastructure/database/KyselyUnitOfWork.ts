...
/**
 * Kysely-based implementation of the Unit of Work pattern.
 * Coordinates transactional operations across multiple repositories using Kysely transactions.
 */
...
/**
 * Factory function to create a KyselyUnitOfWork instance
 */
