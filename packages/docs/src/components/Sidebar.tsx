import { AccountTree, Code, DarkMode, Home, LightMode } from "@mui/icons-material";
import { Box, Divider, Drawer, IconButton, List, ListItem, ListItemButton, ListItemIcon, ListItemText, Tooltip, Typography, useMediaQuery, useTheme as useMuiTheme } from "@mui/material";
                    ...
                    {navigation.map(item => {
                        ...
                        return (
                            <ListItem key={item.name} disablePadding>
                                <NavLink to={item.href} style={{ textDecoration: "none", color: "inherit", width: "100%" }} onClick={onClose}>
                                    {({ isActive }) => (
                                        <ListItemButton
                                            sx={{
                        ...
                        <List sx={{ py: 0 }}>
                            {category.items.map(item => (
                                <ListItem key={item.id} disablePadding>
                                    <NavLink to={item.path} style={{ textDecoration: "none", color: "inherit", width: "100%" }} onClick={onClose}>
                                        {({ isActive }) => (
                                            <ListItemButton
                                                sx={{
                                                    pl: 4,
