    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      <Box sx={{ textAlign: 'center', mb: 8 }}>
        ...
        <Typography variant="h5" color="text.secondary" sx={{ mb: 4, maxWidth: 800, mx: 'auto' }}>
          Developer documentation for the modern full-stack Discord bot application 
          built with TypeScript, featuring a robust backend API and a sleek React frontend.
        </Typography>
          ...
          <Card sx={{ height: '100%' }}>
            <CardContent>
              ...
              <Typography color="text.secondary" sx={{ mb: 2 }}>
                Express.js API with Discord bot functionality, built with TypeScript 
                and following hexagonal architecture principles.
              </Typography>
              <Button
                component={Link}
                to="/guide/backend"
        ...
        <Grid item xs={12} md={6}>
          <Card sx={{ height: '100%' }}>
            <CardContent>
              ...
              <Typography color="text.secondary" sx={{ mb: 2 }}>
                Modern React application with Vite, TypeScript, Tailwind CSS, 
                and state-of-the-art tooling for building user interfaces.
              </Typography>
              <Button
                component={Link}
                to="/guide/frontend"
          ...
          <Card sx={{ height: '100%' }}>
            <CardContent>
              ...
              <Typography color="text.secondary" sx={{ mb: 2 }}>
                ...
                type safety throughout, and comprehensive testing.
              </Typography>
              <Button
                component={Link}
                to="/architecture"
        ...
        <Grid item xs={12} md={6}>
          <Card sx={{ height: '100%' }}>
            <CardContent>
              ...
              <Typography color="text.secondary" sx={{ mb: 2 }}>
                Docker support, CI/CD pipelines, and comprehensive deployment 
        ...
        <Grid container spacing={4}>
          <Grid item xs={12} md={6}>
            ...
            <Box component="ul" sx={{ pl: 2, color: 'text.secondary' }}>
              ...
              <li><strong>Discord.js</strong> - Discord bot functionality</li>
              <li><strong>Prisma</strong> - Database ORM</li>
              <li><strong>Kysely</strong> - Type-safe SQL queries</li>
              <li><strong>Hexagonal Architecture</strong> - Clean code organization</li>
            </Box>
          </Grid>
          <Grid item xs={12} md={6}>
            <Typography variant="h6" sx={{ mb: 2, color: 'primary.main' }}>
